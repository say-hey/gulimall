...
import com.wkl.gulimall.search.feign.ProductFeignService;
import com.wkl.gulimall.search.service.MallService;
import com.wkl.gulimall.search.vo.AttrResponseVo;
import com.wkl.gulimall.search.vo.BrandVo;
...
public class MallServiceImpl implements MallService {
    ...
    private SearchRequest buildSearchRequest(SearchParam Param) {
        ...
        // 1.2 bool - filter [价格区间] 1_500/_500/500_
        if(!StringUtils.isEmpty(Param.getSkuPrice())){
            RangeQueryBuilder rangeQuery = QueryBuilders.rangeQuery("skuPrice");
            String[] s = Param.getSkuPrice().split("_");
            if(s.length == 2){
                // 有三个值 就是区间 1_500分割之后两个值 [1],[500]
